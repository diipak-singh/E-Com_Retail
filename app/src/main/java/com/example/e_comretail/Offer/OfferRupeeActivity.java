...
public class OfferRupeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offer_rupee);
        Intent intent = getIntent();
        strOffer = intent.getStringExtra("OfferRupees");
        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("Offer Under " + strOffer);
        ...
        recyclerView = findViewById(R.id.recycler_offer_rupee);
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(OfferRupeeActivity.this, OfferItemsDisplay.class);
        ...
        if (ref != null) {
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            int ItemPriceAftrGst = Integer.parseInt(ds.getValue(OfferDetails.class).getItemPrice()) + (Integer.parseInt(ds.getValue(OfferDetails.class).getItemPrice()) * Integer.parseInt(ds.getValue(OfferDetails.class).getGstrate()) / 100);
                            int ItemPriceAftrDiscount = ItemPriceAftrGst - (ItemPriceAftrGst * Integer.parseInt(ds.getValue(OfferDetails.class).getDiscount()) / 100);
                            int itemPriceAfterOffer = ItemPriceAftrDiscount - (ItemPriceAftrDiscount * Integer.parseInt(ds.getValue(OfferDetails.class).getOffer()) / 100);
                            if (itemPriceAfterOffer < Integer.parseInt(strOffer))
                        ...
                        OfferAdapter offerAdapter = new OfferAdapter(list, OfferRupeeActivity.this);
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(OfferRupeeActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
